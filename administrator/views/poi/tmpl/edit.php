...
<script type="text/javascript">
    ...
    {
        if (task == 'poi.cancel') {
            Joomla.submitform(task, document.getElementById('poi-form'));
        }
        else {
            
            if (task != 'poi.cancel' && document.formvalidator.isValid(document.id('poi-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_citybranding&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="poi-form" class="form-validate">

	<?php echo JLayoutHelper::render('joomla.edit.title_alias', $this); ?>
    <div class="form-vertical">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CITYBRANDING_TITLE_POI', true)); ?>
        <div class="row-fluid">
            <div class="span6">
